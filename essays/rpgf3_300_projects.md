...
> Originally published on [Mirror](https://mirror.xyz/cerv1.eth/aKLPb2c9n57zNUyOkv8IirYawVba74a1gjjTAe3TPX0). Archived here from Arweave (tx `BmfFb-TTzzjZWqAVubW3V0hKirz_4vHpH1fCz7G7lNo`).

[Open Source Observer](https://www.opensource.observer/) is a platform for measuring the impact of open source software (OSS) contributions. We launched a few months ago with a commitment to [open source everything](https://www.notion.so/Analysis-on-the-300-OSS-projects-applying-for-RetroPGF-3-bdab5633732c459d85caccf7b59c5bd3?pvs=21)*.* Here is our [hello world post](https://gov.optimism.io/t/introducing-open-source-observer-measuring-impact-of-oss-contributions-to-the-op-superchain/7071/1) on the forum ICYMI.
...
![366 RetroPGF projects are currently on Open Source Observer](../assets/img/rpgf3_300_projects_1.png)

These projects have lots of shared contributors too — a theme will explore further later on in this doc!

![Network graph of shared contributors across RetroPGF 3 projects](../assets/img/rpgf3_300_projects_2.png)
...
![Monthly active developers across all RetroPGF 3 projects](../assets/img/rpgf3_300_projects_3.png)
...
![Breakdown of monthly active developers by RetroPGF 2/3 cohort](../assets/img/rpgf3_300_projects_4.png)
...
![Breakdown of monthly active developers by all RetroPGF cohorts](../assets/img/rpgf3_300_projects_5.png)
...
![Project activity 6 months before vs 6 months after RetroPGF 2](../assets/img/rpgf3_300_projects_6.png)
...
(It’s a huge image, scroll down for more analysis afterwards!)

![Monthly active developers by RetroPGF 3 project](../assets/img/rpgf3_300_projects_7.png)
...
![Monthly onchain users by RetroPGF 3 project](../assets/img/rpgf3_300_projects_8.png)
...
![Profiles of the user base for onchain protocols in RetroPGF 3](../assets/img/rpgf3_300_projects_9.png)
...
![](../assets/img/rpgf3_300_projects_10.png)
...
![Sequencer fee contribution by some of the biggest protocols on OP Mainnet](../assets/img/rpgf3_300_projects_11.png)
...
![Sequencer fee contribution by protocol (RetroPGF 3 projects only)](../assets/img/rpgf3_300_projects_12.png)
...
![Downstream impact of package dependencies](../assets/img/rpgf3_300_projects_13.png)
...
![Network graph of the most central RetroPGF 3 projects on GitHub](../assets/img/rpgf3_300_projects_14.png)

We can also identify individuals that have played an outsized role in contributing to multiple projects in the Optimism ecosystem. Here’s a list of the top 150 contributors across all RetroPGF 3 projects since 2019, based on commits and PRs. Individuals like tjayrush ([TrueBlocks](https://www.opensource.observer/project/trueblocks)) and lefterisjp ([rotki](https://www.opensource.observer/project/trueblocks)) have a tremendous history of consistency not only on their own projects but across the ecosystem.

![Leading developers in the OP Ecosystem (based on GitHub activity across RetroPGF 3 projects)](../assets/img/rpgf3_300_projects_15.png)
...
If you’re a data nerd who wants to contribute to this effort, please join [this group chat](https://t.me/osocommunity) and tell us what you’re up to!
