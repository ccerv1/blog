...
After a few months back home living with my parents, I found my way to East Africa again, this time for an international NGO called [TechnoServe](https://www.technoserve.org/).

At the time, TechnoServe stood out among [USAID-funded](../essays/usaid) organizations for its belief that rural businesses, not aid alone, could create durable prosperity. In practice, that meant deploying business advisors to help enterprises like dairy plants and coffee mills secure financing, improve operations, and negotiate with buyers.

My first assignment was helping a network of coffee cooperatives improve their accounting, secure export financing, and sell to Starbucks. That work grew into a much larger effort across East Africa through the [Gates Foundation-backed Coffee Initiative](https://www.gatesfoundation.org/ideas/media-center/press-releases/2008/01/technoserve-to-double-incomes-of-smallscale-farmers-in-east-africa). I built out the initial monitoring and evaluation systems for the region and then launched the office in Ethiopia, where I was TechnoServe's first employee on the ground. Over the next three years, we helped more than 160,000 farmers build new processing mills, access [bank loans](https://disclosures.ifc.org/project-detail/SPI/29228/ethiopian-coffee), and [sell high-quality specialty coffee](https://www.aspenpublicradio.org/2013-07-22/how-an-ethiopian-bean-became-the-cinderella-of-coffee).

Many development programs struggle to produce durable results. The Coffee Initiative held up unusually well and later became [a case study](https://www.hks.harvard.edu/sites/default/files/TNC_CoffeeInitiative%282017%29.pdf) in how sustained execution, strong local teams, and market incentives can reinforce one another.
...
So I traded being the expert in the room for being a beginner again. I joined [Protocol Labs](https://protocol.ai), an R&D network and venture studio, with a broad mandate to explore [funding models for open source projects](https://hypercerts.org). That work took me deep into [public goods funding](../essays/pgf_past_present_future) and [experiments in rewarding open source contributions after the fact](../essays/most_interesting_experiment).
